  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .or(
          `full_name.ilike.%${searchQuery}%,reg_number.ilike.%${searchQuery}%`
        )
        .eq("is_active", true)
        .limit(10);
          ...
          <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }}>
            <GlassCard className="max-w-md w-full p-8 text-center">
              ...
              <p style={{ color: colors.textSecondary }}>
                The payment fee has been successfully waived for{" "}
                {selectedStudent?.full_name}
              </p>
            </GlassCard>
          </motion.div>
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    style={{ color: colors.textSecondary }}
                  >
                    {selectedStudent.reg_number} • {selectedStudent.level} •{" "}
                ...
                <>
                  ...
                  >
                    <p className="text-sm" style={{ color: colors.accentMint }}>
                      💡 Showing {paymentTypes.length} unpaid dues for{" "}
                      {selectedStudent.full_name}
                    </p>
                  </div>
            ...
            >
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-white mb-2">
                  Waiver Reason{" "}
                  <span style={{ color: colors.statusUnpaid }}>*</span>
                </label>
                <div className="relative">
                  ...
                  >
                    <option value="" style={{ background: "#1A0E09" }}>
                      Select reason...
                    </option>
                    <option
                    ...
                    <option
                      value="class_executive"
                      style={{ background: "#1A0E09" }}
                    >
                      👔 Class Executive Role
                    </option>
                    <option
                      value="scholarship"
                      style={{ background: "#1A0E09" }}
                    ...
                    <option
                      value="departmental_support"
                      style={{ background: "#1A0E09" }}
                    >
                      🏫 Departmental Support
                    </option>
                    <option value="other" style={{ background: "#1A0E09" }}>
                      📝 Other
                    </option>
                  </select>
              ...
              <div className="mb-4">
                <div
                  ...
                  style={{
                    background: notifyStudent
                      ? "rgba(6, 182, 212, 0.1)"
                      : "rgba(255, 255, 255, 0.03)",
                    borderColor: notifyStudent
                      ? "rgba(6, 182, 212, 0.3)"
                      : "rgba(255, 104, 3, 0.2)",
                  }}
                >
              ...
              {waiverReason && (
                ...
                >
                  ...
                  <p className="text-sm text-white">
                    The student will see this payment marked as "WAIVED" with
                    the reason displayed in their payment history.
                  </p>
                </div>
              )}
            </motion.div>
